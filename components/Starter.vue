<template>
  <div id="lol" class="flex justify-center items-center w-full">
    <div id="box" class="flex flex-col items-center">
      ...
      <div class="mt-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          href="https://github.com/Meldanor"
        >
          <img src="/logos/github-brands.svg" alt="github logo">
        </a>
        <a
          style="width: 50px; height: 50px"
          class="mx-1 inline-block"
          target="_blank"
          rel="noreferrer"
          href="https://twitter.com/Meldanor"
        >
          <img src="/logos/twitter-brands.svg" alt="twitter logo">
